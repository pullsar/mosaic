...
enum GameSceneShape { roundedRect, circle, matchstick, cup, coin, orb }
...
final class GameSceneObject {
  ...
  factory GameSceneObject.fromJson(Map<String, Object?> json, int index) {
    final shape = switch (json['shape']) {
      ...
      'coin' => GameSceneShape.coin,
      'orb' => GameSceneShape.orb,
  ...
  Map<String, Object?> toJson() => {
    ...
    'shape': switch (shape) {
      ...
      GameSceneShape.coin => 'coin',
      GameSceneShape.orb => 'orb',
    },
    ...rect.toJson(),
    'tone': tone.name,
