...
void main() {
  test('migration failure preserves a verified database without quarantine', () {
    final temp = Directory.systemTemp.createTempSync('mosaic-migration-failure-');
    ...
    try {
      ...
      try {
        expect(
          reopened.select('pragma user_version').first.values.first,
          1,
        );
        expect(
          reopened.select(
