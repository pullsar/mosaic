...
void main() {
  test('production capability envelope widens only for installed delivery kinds', () {
    ...
    expect(
      secureCapabilities.presentationTypes,
      <String>{'text', 'canvas', 'image', 'video_clip', 'audio'},
    );
    secure.close();
